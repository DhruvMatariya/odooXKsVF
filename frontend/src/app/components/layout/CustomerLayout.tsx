...
export function CustomerLayout() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAFAF8' }}>
      {/* Top navbar */}
      <nav style={{
        background: '#344C3D', borderBottom: '1px solid rgba(255,255,255,0.08)',
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', height: '56px', gap: '24px' }}>
          ...
          <NavLink to="/customer/products" style={{ display: 'flex', alignItems: 'center', gap: '8px', textDecoration: 'none', marginRight: '16px' }}>
            ...
            <span style={{ color: '#FAFAF8', fontWeight: 700, fontSize: '17px', letterSpacing: '-0.01em' }}>Rentsure</span>
          </NavLink>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <NavLink to="/customer/profile" style={({ isActive }) => ({
              ...
              background: isActive ? 'rgba(115,138,110,0.25)' : 'transparent',
              color: '#BFCFBB', textDecoration: 'none', fontSize: '13px',
            })}>
              <User size={14} />
            ...
            <button
              ...
              style={{
                ...
                color: '#8EA58C', cursor: 'pointer', fontSize: '13px',
              }}
            >
              <LogOut size={14} />
            </button>
