...
export const catalogController = {
  ...
  async createCategory(req, res) {
    ...
    res.status(HTTP_STATUS.CREATED).json({
      success: true,
      message: MESSAGES.CATALOG.CATEGORY_CREATED,
  ...
  async updateInventory(req, res) {
    ...
    res.status(HTTP_STATUS.OK).json({
      ...
      data: {
        total: inventory.available + inventory.reserved + inventory.rented + inventory.maintenance,
  ...
  // GET /api/v1/vendor/return-slots?date=
  ...
  // PUT /api/v1/vendor/late-fee-rule
  ...
  // PUT /api/v1/vendor/cancellation-policy
