export const MESSAGES = {
    ...
    ORDERS: {
        ...
        INVENTORY_INSUFFICIENT: 'Insufficient inventory available',
        PRODUCT_NOT_ACTIVE: 'Product is not available for rent',
        RENTAL_PERIOD_INVALID: 'Rental period start must be in the future',
        ORDER_CONFIRMED: 'Order confirmed successfully',
        PAYMENT_FAILED: 'Payment failed',
        PAYMENT_INITIATION_FAILED: 'Payment initiation failed',
        PAYMENT_NOT_SUCCEEDED: 'Payment not succeeded',
